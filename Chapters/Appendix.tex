...
Here are reported the tables containing the all the results, divided by sensor
...
\begin{table}[htbp]
    \small
    \centering
    \caption{Summary of the results from the sensor: CNM-W4.}
    \label{tab:results_CNM-W4}
    \input{Chapters/Results_tables/table_results_CNM-W4}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{Summary of the results from the sensor: CNM-W5.}
    \label{tab:results_CNM-W5}
    \input{Chapters/Results_tables/table_results_CNM-W5}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{CNM-W5-1.5E15.}
    \label{tab:results_CNM-W5-1.5E15}
    \input{Chapters/Results_tables/table_results_CNM-W5-1.5E15}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{Summary of the results from the sensor: CNM-W3-2.5E15.}
    \label{tab:results_CNM-W3-2.5E15}
    \input{Chapters/Results_tables/table_results_CNM-W3-2.5E15}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{Summary of the results from the sensor: USTC2.1-W17.}
    \label{tab:results_USTC2.1-W17}
    \input{Chapters/Results_tables/table_results_USTC2.1-W17}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{Summary of the results from the sensor: IMEv3-W12-2x2.}
    \label{tab:results_IMEv3-W12-2x2}
    \input{Chapters/Results_tables/table_results_IMEv3-W12-2x2}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{IMEv3-W12-1x3}
    \label{tab:results_IMEv3-W12-1x3}
    \input{Chapters/Results_tables/table_results_IMEv3-W12-1x3}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{IMEv2-W7-6.5E14}
    \label{tab:results_IMEv2-W7-6.5E14}
    \input{Chapters/Results_tables/table_results_IMEv2-W7-6.5E14}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{IMEv3-W16-8E14}
    \label{tab:results_IMEv3-W16-8E14}
    \input{Chapters/Results_tables/table_results_IMEv3-W16-8E14}
\end{table}
...
\begin{table}[htbp]
    ...
    \input{Chapters/Results_tables/table_results_IMEv3-W16-2.5E15}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{IMEv2-W7-1E14}
    \label{tab:results_IMEv2-W7-1E14}
    \input{Chapters/Results_tables/table_results_IMEv2-W7-1E14}
\end{table}
...
\begin{table}[htbp]
    \small
    \centering
    \caption{IMEv3-W12-2x2-1.5E15}
    \label{tab:results_IMEv3-W12-2x2-1.5E15}
    \input{Chapters/Results_tables/table_results_IMEv3-W12-2x2-1.5E15}
\end{table}
...
%     \small
%     \centering
%     \caption{IMEv3-W16-1x3-1.5E15}
%     \label{tab:results_IMEv3-W16-1x3-1.5E15}
%     \input{Chapters/Results_tables/table_results_IMEv3-W16-1x3-1.5E15}
% \end{table}
...
% \cite[189]{NAP20066}
% \input{Chapters/Vavilov_Landau/Vavilov approximation to Landau.tex}
\input{Chapters/Vavilov.tex}
